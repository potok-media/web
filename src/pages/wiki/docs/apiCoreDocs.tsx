...
export function buildManifestDoc(t: TFunction<"wiki">) {
  ...
  return () => (
    <div>
      ...
      <p className="doc-body-text">{s.permissionsIntro}</p>
      ...
      <p className="doc-body-text">{s.slotsIntro}</p>
      {renderTwoColumnTable(
      ...
      <p className="doc-body-text">{s.configIntro}</p>
      {renderThreeColumnTable(
...
export function buildStateDoc(t: TFunction<"wiki">) {
  ...
  return (openInSandbox: (code: string) => void) => (
    <div>
      ...
      <p className="doc-body-text">{s.subscriptionText}</p>
      ...
      <p className="doc-body-text">{s.reactiveExampleText}</p>
